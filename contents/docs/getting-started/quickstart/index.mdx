...
- Read [Concepts → Architecture](/docs/concepts/architecture) for a tour of the controller fleet and the isolation model.
- Read [Concepts → Rollouts](/docs/concepts/rollouts) to layer ordered, label-driven orchestration on top of your Workspaces.
- Read [Concepts → Variable Sets](/docs/concepts/variable-sets) to wire Kubernetes [Secrets](https://kubernetes.io/docs/concepts/configuration/secret/) into Terraform inputs.
