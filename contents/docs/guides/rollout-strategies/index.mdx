...
- **Putting policy categories on Workspace labels and selecting on them.** Policy selection is a different concern; it lives under `spec.validation.policySelector` on the Workspace or Project, not on Workspace labels.
